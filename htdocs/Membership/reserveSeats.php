	...
	try 
		{
				...
				echo "<form method='POST' action='reserveSeats_continue.php'>\n";
				echo "<input type='hidden' name='show' value='$showID' />\n";
				...
				for($j=0; $j< $row->leftRow; $j++)
				{
					...
					echo "L$stno<br /><input class='seated' id='Seat".$num."' type='checkbox' name='seats[]' value='Row$rowno L$stno'  onclick='checkSeat(".$num.")'/>";
				...
				for($j=0; $j< $row->midRow; $j++)
				{
					...
					echo "<td align='center'>";
					echo "<div id='SeatDiv".$num."' class='seat'>";
					echo "M$stno<br /><input id='Seat".$num."' type='checkbox' name='seats[]' value='Row$rowno M$stno' onclick='checkSeat(".$num.")'>";
					echo "</td>";
					echo "</div>\n";
				}
				//echo "</div>";
				...
				for($j=0; $j< $row->rightRow; $j++)
				{
					...
					echo "<td align='center'>";
					echo "<div id='SeatDiv".$num."' class='seat'>";
					echo "R$stno<br /><input id='Seat".$num."' type='checkbox' name='seats[]' value='Row$rowno R$stno' onclick='checkSeat(".$num.")'>";
					echo "</td>";
					echo "</div>\n";
				}
				...
				echo"<table align='center'><tr><td><input type=submit name='continueReserve' class='cardbutton' value='Continue >>'></td></tr></table>";
				echo "</table></form>\n";
				echo "</div>\n";
