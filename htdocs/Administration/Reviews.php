...
require("Header.php");
require("Navbar.php");?>
<script> document.getElementById('reviewtab').className='active';
...
try 
	{
		...
		echo "</td>";
		echo "<td>";
		echo "<a href='Reviews.php'>Clear Filter</a>";
		echo "</td>";
		echo "</tr>";
		echo "</table>";
		echo "</div>";
		...
		while($row= $statement->fetch(PDO::FETCH_OBJ))
			{
				$no++;
				echo "<form method='POST' action ='reviewMovie.php'> \n";
				...
				echo "<tr>\n";
				echo "<td align='center'>\n";
				echo "<input align='center' class='cardbutton' type='submit' name='viewRating' value='Ratings'><br />\n";
